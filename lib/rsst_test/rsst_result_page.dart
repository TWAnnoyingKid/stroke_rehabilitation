...
class _RsstResultPageState extends State<RsstResultPage> with SingleTickerProviderStateMixin {
  ...
  Future<void> _initAudioPlayer() async {
    ...
    try {
      ...
      // 舊版: play + isLocal: true 即可播放本機檔案
      await _audioPlayer!.play(widget.recordingPath!, isLocal: true);
      await _audioPlayer!.pause(); // 先暫停播放

      // 舊版 getDuration() 回傳 int 毫秒
      final int? duration = await _audioPlayer!.getDuration();
      if (duration != null) {
        setState(() {
  ...
  void _startPositionTimer() {
    ...
    _positionTimer = Timer.periodic(Duration(milliseconds: 200), (timer) async {
      // 舊版 getCurrentPosition() 回傳 int (毫秒)
          ...
          children: [
            ...
            ElevatedButton(
              ...
              style: ElevatedButton.styleFrom(
                primary: const Color(0xFFF4DB60),
                onPrimary: const Color(0xFFC50D1C),
