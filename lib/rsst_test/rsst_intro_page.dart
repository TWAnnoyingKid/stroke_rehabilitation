                            ...
                            Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  _buildStepItem('2', '您有5秒鐘準備時間，請將手機放置於頸部右側以便錄製吞嚥聲音。'),
                                  _buildStepItem('3', '聽到提示音後，開始盡可能多次地吞口水。'),
                                  _buildStepItem('4', '測驗會持續30秒，完成後系統會自動計算您的吞嚥次數。'),
                            ...
                            Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  _buildNoteItem('測試時身體保持直立坐姿，頭部自然位置，不要過度前傾或後仰。'),
                                  _buildNoteItem('手機應放在頸部右側喉結附近，但不要貼得太緊，以免影響錄音效果。'),
                  ...
                  if (!_permissionsGranted)
                    Padding(
                      ...
                      child: Container(
                        ...
                        child: Row(
                          children: [
                            Icon(Icons.warning_amber_rounded, color: Color(0xFFC50D1C)),
                            SizedBox(width: 10),
                            Expanded(
                              child: Text(
                                '需要麥克風權限才能進行測驗和錄音',
                  ...
                  Padding(
                    ...
                    child: ElevatedButton(
                      ...
                      style: ElevatedButton.styleFrom(
                        primary: Color(0xFFF4DB60),
                        onPrimary: Color(0xFFC50D1C),
