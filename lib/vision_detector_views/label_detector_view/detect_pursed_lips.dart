...
class pursed_lips extends StatefulWidget {
  @override
  State<pursed_lips> createState() => _ImageLabelViewState();
}

class _ImageLabelViewState extends State<pursed_lips>{
  ...
  bool _isBusy = false;
  Detector_pursed_lips smile = Detector_pursed_lips();
...
class Detector_pursed_lips {
  ...
  String TargetRemind  = '請保持抿嘴';//目標提醒
...
Future<void> endout6() async {
  DateTime now = DateTime.now();
  String formattedDate = DateFormat('yyyy-MM-dd').format(now);
  var url;
  if(Face_Detect_Number==6){                //抿嘴
