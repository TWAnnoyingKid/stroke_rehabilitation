...
class flick_tougue extends StatefulWidget {
  @override
  State<flick_tougue> createState() => _ImageLabelViewState();
}

class _ImageLabelViewState extends State<flick_tougue>{
  ...
  bool _isBusy = false;
  Detector_flick_tougue smile = Detector_flick_tougue();
...
Future<void> endout5() async {
  DateTime now = DateTime.now();
  String formattedDate = DateFormat('yyyy-MM-dd').format(now);
  var url;
  if(Face_Detect_Number==5){                //抿嘴
